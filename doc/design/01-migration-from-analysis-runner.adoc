...
via `:local/root`. While not strictly necessary when not running from a jar, I do
this in all cases for a consistent code path.
...
| 0.5.2
a| * part of current integration tests
* added by Martin as fix for failing import
* cljs
