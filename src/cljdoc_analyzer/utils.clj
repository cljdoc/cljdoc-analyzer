...
(defn- find-file-in-repo
  "Given a classpath-relative `file` (as from the output of
   `cljdoc-analyzer.reader.clojure/read-namespaces`), and a sequence of `sources`
...
(defn add-source-paths
  "Accepts `ns-seq`, a sequence of namespaces (generated by
   `cljdoc-analyzer.reader.clojure/read-namespaces` or
   `cljdoc-analyzer.reader.clojurescript/read-namespaces`), the project directory
