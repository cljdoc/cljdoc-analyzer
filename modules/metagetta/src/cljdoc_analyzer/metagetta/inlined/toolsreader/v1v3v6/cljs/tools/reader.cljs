...
(ns ^{:mranderson/inlined true} cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.cljs.tools.reader
  (:refer-clojure :exclude [read read-line read-string char read+string
                            default-data-readers *default-data-reader-fn*
                            *data-readers* *suppress-read*])
  (:require-macros [cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.cljs.tools.reader.reader-types :refer [log-source]])
  (:require [cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.cljs.tools.reader.reader-types :refer
             [read-char unread peek-char indexing-reader?
              get-line-number get-column-number get-file-name
              string-push-back-reader]]
            [cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.cljs.tools.reader.impl.utils :refer
            ...
            [cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.cljs.tools.reader.impl.commons :refer
             [number-literal? read-past match-number parse-symbol read-comment throwing-reader]]
            [cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.cljs.tools.reader.impl.errors :as err]
...
(defn read
  "Reads the first object from an IPushbackReader.
   ...
   To read data structures only, use cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.cljs.tools.reader.edn/read

   Note that the function signature of cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.cljs.tools.reader/read and
   cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.cljs.tools.reader.edn/read is not the same for eof-handling"
...
(defn read-string
  "Reads one object from the string s.
   ...
   To read data structures only, use cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.cljs.tools.reader.edn/read-string

   Note that the function signature of cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.cljs.tools.reader/read-string and
   cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.cljs.tools.reader.edn/read-string is not the same for eof-handling"
  ([s]
     (read-string {} s))
  ([opts s]
