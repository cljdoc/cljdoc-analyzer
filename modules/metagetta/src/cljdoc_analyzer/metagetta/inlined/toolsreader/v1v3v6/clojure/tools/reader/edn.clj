...
(ns ^{:mranderson/inlined true} cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.edn
  ...
  (:require [cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.reader-types :refer
            ...
            [cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.impl.utils :refer
            ...
            [cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader :refer [default-data-readers]])
...
(defn read
  "Reads the first object from an IPushbackReader or a java.io.PushbackReader.
   ...
   cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.edn/read doesn't depend on dynamic Vars, all configuration
...
(defn read-string
  "Reads one object from the string s.
   ...
   opts is a map as per cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.edn/read"
