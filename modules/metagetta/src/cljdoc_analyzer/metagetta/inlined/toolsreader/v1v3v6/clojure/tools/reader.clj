...
(ns ^{:mranderson/inlined true} cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader
  (:refer-clojure :exclude [read read-line read-string char read+string
                            default-data-readers *default-data-reader-fn*
                            *read-eval* *data-readers* *suppress-read*])
  (:require [cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.reader-types :refer
            ...
            [cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.impl.utils :refer :all] ;; [char ex-info? whitespace? numeric? desugar-meta]
            [cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.impl.errors :as err]
            [cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.impl.commons :refer :all]
            [cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.default-data-readers :as data-readers])
  (:import (clojure.lang PersistentHashSet IMeta
                         RT Symbol Reflector Var IObj
                         PersistentVector IRecord Namespace)
           cljdoc_analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.reader_types.SourceLoggingPushbackReader
...
(def ^:dynamic *read-eval*
   ...
   ***WARNING***
   ...
   used with untrusted sources. See also: cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.edn/read.
...
(def ^:dynamic *data-readers*
  "Map from reader tag symbols to data reader Vars.
   ...
   Default reader tags are defined in cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader/default-data-readers
...
(defn read
   ...
   ***WARNING***
   ...
   To read data structures only, use cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.edn/read

   Note that the function signature of cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader/read and
   cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.edn/read is not the same for eof-handling"
...
(defn read-string
   ...
   ***WARNING***
   ...
   To read data structures only, use cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.edn/read-string

   Note that the function signature of cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader/read-string and
   cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.edn/read-string is not the same for eof-handling"
  ([s]
     (read-string {} s))
  ([opts s]
