...
(ns ^{:mranderson/inlined true} cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.reader-types
  (:refer-clojure :exclude [char read-line])
  (:require [cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.impl.utils :refer [char whitespace? newline? make-var]])
...
(extend-protocol ReaderCoercer
  ...
  cljdoc_analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.reader_types.Reader
  (to-rdr [rdr] rdr)
  String
...
(extend-protocol PushbackReaderCoercer
  ...
  cljdoc_analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.reader_types.PushbackReader
  (to-pbr [rdr buf-len] (push-back-reader rdr buf-len))
  String
...
(defn indexing-reader?
  ...
  [rdr]
  (or (instance? cljdoc_analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.reader_types.IndexingReader rdr)
      (instance? LineNumberingPushbackReader rdr)
      (and (not (instance? cljdoc_analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.reader_types.PushbackReader rdr))
           (not (instance? cljdoc_analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.reader_types.StringReader rdr))
           (not (instance? cljdoc_analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.reader_types.InputStreamReader rdr))
