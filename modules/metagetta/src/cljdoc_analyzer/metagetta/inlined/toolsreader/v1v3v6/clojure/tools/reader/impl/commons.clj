...
(ns ^{:mranderson/inlined true} cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.impl.commons
  (:refer-clojure :exclude [char])
  (:require [cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.reader-types :refer [peek-char read-char]]
            [cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.impl.errors :refer [reader-error]]
            [cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader.impl.utils :refer [numeric? newline? char]])
