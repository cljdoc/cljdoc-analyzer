...
(ns ^{:mranderson/inlined true} cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.cljs.tools.reader.edn
  (:refer-clojure :exclude [read read-string char default-data-readers])
  (:require [cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.cljs.tools.reader.impl.errors :as err]
            [cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.cljs.tools.reader.reader-types :refer
            ...
            [cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.cljs.tools.reader :refer [default-data-readers]]
...
(defn read
  "Reads the first object from an IPushbackReader.
   ...
   cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.cljs.tools.reader.edn/read doesn't depend on dynamic Vars, all configuration
...
(defn read-string
  "Reads one object from the string s.
   ...
   opts is a map as per cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.cljs.tools.reader.edn/read"
