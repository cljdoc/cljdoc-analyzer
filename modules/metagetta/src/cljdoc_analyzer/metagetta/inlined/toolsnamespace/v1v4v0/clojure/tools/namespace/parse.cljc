...
(ns ^{:mranderson/inlined true} cljdoc-analyzer.metagetta.inlined.toolsnamespace.v1v4v0.clojure.tools.namespace.parse
  (:require #?(:clj [cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.clojure.tools.reader :as reader]
               :cljs [cljdoc-analyzer.metagetta.inlined.toolsreader.v1v3v6.cljs.tools.reader :as reader])
            [clojure.set :as set]))
