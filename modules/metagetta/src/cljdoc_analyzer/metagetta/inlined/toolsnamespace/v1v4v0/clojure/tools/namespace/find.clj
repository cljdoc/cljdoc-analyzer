...
(ns 
  ^{:mranderson/inlined true} cljdoc-analyzer.metagetta.inlined.toolsnamespace.v1v4v0.clojure.tools.namespace.find
  (:require [cljdoc-analyzer.metagetta.inlined.javaclasspath.v1v0v0.clojure.java.classpath :as classpath]
            [clojure.java.io :as io]
            [clojure.set :as set]
            [cljdoc-analyzer.metagetta.inlined.toolsnamespace.v1v4v0.clojure.tools.namespace.file :as file]
            [cljdoc-analyzer.metagetta.inlined.toolsnamespace.v1v4v0.clojure.tools.namespace.parse :as parse])
...
(defn find-sources-in-dir
  ...
  defined in cljdoc-analyzer.metagetta.inlined.toolsnamespace.v1v4v0.clojure.tools.namespace.find."
  {:added "0.3.0"}
  ([dir]
...
(defn find-ns-decls
  ...
  forms. Use with cljdoc-analyzer.metagetta.inlined.javaclasspath.v1v0v0.clojure.java.classpath to search Clojure's
  classpath.
...
(defn find-namespaces
  ...
  namespaces. Use with cljdoc-analyzer.metagetta.inlined.javaclasspath.v1v0v0.clojure.java.classpath to search Clojure's
  classpath.
